...
%-------------------------------------------------------------------------------
%
\title[On the numerical stability of an oscillating galaxy far, far away]% Title used in the abstract (optional)
{% Title of the thesis
	On the numerical stability\\of an oscillating galaxy \\ far, far away
}%
...
% Paper 1
%
%\include{stabilization/paper}
%\include{validation/paper}
\include{unsteady_model/paper}
%-------------------------------------------------------------------------------
% Paper 2
%
